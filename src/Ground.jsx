...
export default function Ground() {
  ...
  const aoMap = useLoader(
    TextureLoader,
    import.meta.env.BASE_URL + 'textures/ground-ao.png'
  );
  const alphaMap = useLoader(
    TextureLoader,
    import.meta.env.BASE_URL + 'textures/alpha-map.png'
  );

  useEffect(() => {
    if (!gridMap) return;

    gridMap.anistropy = 16;
  }, [gridMap]);
    ...
    <>
      ...
      >
        ...
        <MeshReflectorMaterial
          ...
          roughness={0.4}
          dithering={true}
          blur={[1024, 512]} // Blur ground reflextions [width, height], 0 skips blur
